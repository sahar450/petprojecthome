...
export default function Sidebar() {
  const inforesmenu = [
    { icon: home, label: 'خانه', to: '/admin' },
    { icon: user, label: ' کاربران ', to: '/Veterinarian' },
    { icon: pet, label: 'پت ها', to: '/Editversion' },
    { icon: info, label: ' نسخه ها', to: '/Supervisor' },
    { icon: calendar, label: ' ملاقات ها', to: '/Petfriend' },
