    ...
    <Cardcustom sx={{
      ...
      <Box>
        ...
        <Box sx={{ display: "flex" , mt:"8px"}}>
          ...
          <Box>
            <Txt sx={{ display: { lg: "none", xs: "block",  md: "none"} }} mycolor={color} mysize="13px" myweight="500" myfont="Shabnam" mymargin="8px 8px 0px 0px">
              {ditile}
      ...
      <CardContent sx={{ padding: "0px !important", mr: "12px" }}>
        <Box sx={{ display: { lg: "block", md: "block", xs: "none" } }}>
          ...
          <Box>
            <Txt mycolor={color} mysize="18px" myweight="500" myfont="Shabnam" mymargin="8px 0px 0px 0px">
              {ditile}
