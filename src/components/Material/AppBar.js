...
const menuItems = [
    { text: 'خانه', icon: home, href: '/admin' },
    { text: ' کاربران', icon: user, href: '/Veterinarian' },
    { text: 'پت ها', icon: pet, href: '/Editversion' },
    { text: 'نسخه ها', icon: info, href: '/Supervisor' },
    { text: 'ملاقات ها', icon: calendar, href: '/Petfriend' },
